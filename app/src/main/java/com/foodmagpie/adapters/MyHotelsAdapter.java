...
public class MyHotelsAdapter extends BaseAdapter {
    List<HotelPojo> hotel;
    Context con;
    String url= "http://covidinformation.live/food/";
    ProgressDialog progressDialog;

    public MyHotelsAdapter(List<HotelPojo> hotel, Context con) {
        this.hotel = hotel;
        this.con = con;
    }
    ...
    public View getView(final int pos, View view, ViewGroup viewGroup) {
        ...
        imgedit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("hid",hotel.get(pos).getHid());
        ...
        imgdelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Call<ResponseData> call = service.deletehotel(hotel.get(pos).getHid());
