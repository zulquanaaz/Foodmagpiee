...
public class CharityProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progress = new ProgressDialog(CharityProfileActivity.this);
        ...
        reg.enqueue(new Callback<List<ProfilePojo>>() {
            ...
            public void onFailure(Call<List<ProfilePojo>> call, Throwable t) {
                progress.dismiss();
                Toast.makeText(CharityProfileActivity.this,"fail",Toast.LENGTH_LONG).show();
            }
        });
                ...
                call.enqueue(new Callback<ResponseData>() {
                    ...
                    public void onResponse(Call<ResponseData> call, Response<ResponseData> response) {
                        ...
                        if (response.body().status.equals("true")) {
                            Toast.makeText(CharityProfileActivity.this, response.body().message, Toast.LENGTH_LONG).show();
                            Intent intent = new Intent(CharityProfileActivity.this, CharityhomeActivity.class);
                    ...
                    public void onFailure(Call<ResponseData> call, Throwable t) {
                        progress.dismiss();
                        Toast.makeText(CharityProfileActivity.this, t.getMessage(), Toast.LENGTH_LONG).show();
                    }
                });
            }
        });
