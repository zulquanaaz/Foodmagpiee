    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnsubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                progress = new ProgressDialog(EditHotelActivity.this);
                progress.setMessage("Updating please wait");
                progress.show();
                ApiService service = RetroClient.getRetrofitInstance().create(ApiService.class);
                Call<ResponseData> call = service.updateHotel(id,name,phone,address);
                call.enqueue(new Callback<ResponseData>() {
                    ...
                    public void onResponse(Call<ResponseData> call, Response<ResponseData> response) {
                        ...
                        if (response.body().status.equals("true")) {
                            ...
                            Intent intent = new Intent(EditHotelActivity.this, HotelHomeActivity.class);
