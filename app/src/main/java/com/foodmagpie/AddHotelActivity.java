...
public class AddHotelActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks {
        ...
        btnadd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (etphone.getText().toString().isEmpty()) {
                    Toast.makeText(AddHotelActivity.this, "Enter Phone", Toast.LENGTH_SHORT).show();
                    return;
                } else if (etname.getText().toString().isEmpty()) {
                    Toast.makeText(AddHotelActivity.this, "Enter Name", Toast.LENGTH_SHORT).show();
                    return;
                } else if (etaddress.getText().toString().isEmpty()) {
                    Toast.makeText(AddHotelActivity.this, "Enter Address", Toast.LENGTH_SHORT).show();
                    return;
                }
                else {
                    addHotel();
    ...
    private void addHotel() {
        progress = new ProgressDialog(AddHotelActivity.this);
        ...
        Call<ResponseData> fileUpload = api.addhotel(fileToUpload, map);
        ...
        fileUpload.enqueue(new Callback<ResponseData>() {
            ...
            public void onResponse(Call<ResponseData> call, Response<ResponseData> response) {
                ...
                startActivity(new Intent(AddHotelActivity.this,HotelHomeActivity.class));
                finish();
            }
