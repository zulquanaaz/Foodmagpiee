...
public class MyHotelsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnaddhotel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i=new Intent(MyHotelsActivity.this,AddHotelActivity.class);
                startActivity(i);
            }
        });
    ...
    public void getHotels() {
        loading = new ProgressDialog(MyHotelsActivity.this);
        loading.setMessage("Loading");
        loading.show();
        SharedPreferences sharedPreferences = getSharedPreferences(Utils.SHREF, Context.MODE_PRIVATE);
        String email = sharedPreferences.getString("user_name", "def-val");
        ApiService apiService = RetroClient.getRetrofitInstance().create(ApiService.class);
        Call<List<HotelPojo>> call= apiService.myhotels(email);
        call.enqueue(new Callback<List<HotelPojo>>() {
            ...
            public void onResponse(Call<List<HotelPojo>> call, Response<List<HotelPojo>> response) {
                ...
                if (response.body() == null) {
                    Toast.makeText(MyHotelsActivity.this, "No data found", Toast.LENGTH_SHORT).show();
                } else {
                    hotelsPojos = response.body();
                    hotel_list.setAdapter(new MyHotelsAdapter(hotelsPojos, MyHotelsActivity.this));
                }
            }
            @Override
            public void onFailure(Call<List<HotelPojo>> call, Throwable t) {
                loading.dismiss();
                Toast.makeText(MyHotelsActivity.this, "Something went wrong...Please contact admin !", Toast.LENGTH_SHORT).show();
            }
        });
    }
