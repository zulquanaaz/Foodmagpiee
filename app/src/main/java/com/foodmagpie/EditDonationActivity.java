        ...
        btnupdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if((etfoodname.getText().toString().isEmpty())){
                    ...
                    Toast.makeText(EditDonationActivity.this, "Enter Quantity", Toast.LENGTH_SHORT).show();
                    return;
                }

                else {

                    progress = new ProgressDialog(EditDonationActivity.this);
                    progress.setMessage("Updating please wait");
                    progress.show();


                    ApiService service = RetroClient.getRetrofitInstance().create(ApiService.class);
                    Call<ResponseData> call = service.updatedonation(etfoodname.getText().toString(), etquantity.getText().toString(), sptype.getSelectedItem().toString(), sphotel.getSelectedItem().toString(), getIntent().getStringExtra("did"));
                    ...
                    call.enqueue(new Callback<ResponseData>() {
                        ...
                        public void onResponse(Call<ResponseData> call, Response<ResponseData> response) {
                            ...
                            if (response.body().status.equals("true")) {
                                Toast.makeText(EditDonationActivity.this, response.body().message, Toast.LENGTH_LONG).show();
                                Intent intent = new Intent(EditDonationActivity.this, HotelHomeActivity.class);
                        ...
                        public void onFailure(Call<ResponseData> call, Throwable t) {
                            progress.dismiss();
                            Toast.makeText(EditDonationActivity.this, t.getMessage(), Toast.LENGTH_LONG).show();
                        }
                    });
                ...
                if (response.body()!=null) {
                    ...
                    if(name!=null) {
                        if(name.size()>0) {
                            ...
                            ArrayAdapter<String> adp = new ArrayAdapter<String>(EditDonationActivity.this, android.R.layout.simple_spinner_dropdown_item, cname);
