...
public class HotelProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progress = new ProgressDialog(HotelProfileActivity.this);
        ...
        reg.enqueue(new Callback<List<ProfilePojo>>() {
            ...
            public void onFailure(Call<List<ProfilePojo>> call, Throwable t) {
                progress.dismiss();
                Toast.makeText(HotelProfileActivity.this,"fail",Toast.LENGTH_LONG).show();
            }
        });
                ...
                call.enqueue(new Callback<ResponseData>() {
                    ...
                    public void onResponse(Call<ResponseData> call, Response<ResponseData> response) {
                        ...
                        if (response.body().status.equals("true")) {
                            Toast.makeText(HotelProfileActivity.this, response.body().message, Toast.LENGTH_LONG).show();
                            Intent intent = new Intent(HotelProfileActivity.this, HotelHomeActivity.class);
                    ...
                    public void onFailure(Call<ResponseData> call, Throwable t) {
                        progress.dismiss();
                        Toast.makeText(HotelProfileActivity.this, t.getMessage(), Toast.LENGTH_LONG).show();
                    }
                });
            }
        });
