...
public class ViewRecipiesPojo1 {
    @SerializedName("id")
    private String id;
    ...
    public ViewRecipiesPojo1(String id, String img_url, String ingredients, String recipe_name, String recipe_procedure, String rating) {
        this.setId(id);
